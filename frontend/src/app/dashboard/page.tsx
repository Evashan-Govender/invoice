    ...
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-sb-grey-2 font-medium">Loading dashboard...</p>
        </div>
      </div>
    );
  }
      ...
      <aside className="sidebar">
        <div className="sidebar-brand">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-md font-bold gradient-text">ZeroTouch AP™</h1>
        ...
        <nav className="sidebar-nav">
          ...
          >
            ...
            {stats.totalInvoices > 0 && (
              /* Sambe Green badge — makes green brand color visible in nav */
              <span className="ml-auto text-white text-xs font-bold px-2.5 py-1 rounded-full" style={{backgroundColor: '#4B9200'}}>
                {stats.totalInvoices}
              </span>
            )}
          </button>

          <div className="pt-3 mt-3 border-t border-sb-grey-2-10">
            <button
            ...
            <div className="animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div className="card p-6 group hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-sb-green">Total Invoices</p>
                      <p className="text-3xl font-bold text-sb-grey-1 mt-2">
                        {stats.totalInvoices}
                      </p>
                    </div>
                    <div className="p-3 bg-gradient-to-br from-sb-blue-10 to-sb-light-blue-20 rounded-xl group-hover:scale-110 transition-transform">
                      <svg className="w-8 h-8 text-sb-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                      </svg>
                    </div>
                  </div>
                  <div className="mt-4 flex items-center text-sm">
                    <span className="text-sb-green font-medium">+{stats.recentActivity.today}</span>
                    <span className="text-sb-grey-2-50 ml-2">uploaded today</span>
                  </div>
                </div>
                ...
                <div className="card p-6 group hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-sb-green">Completed</p>
                      <p className="text-3xl font-bold text-sb-green mt-2">
                        {stats.completed}
                      </p>
                    </div>
                    <div className="p-3 bg-gradient-to-br from-sb-green-10 to-sb-light-green-20 rounded-xl group-hover:scale-110 transition-transform">
                      <svg className="w-8 h-8 text-sb-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="mt-4">
                    <div className="progress-bar">
                      <div 
                        className="progress-bar-fill bg-gradient-to-r from-sb-green to-sb-green"
                ...
                <div className="card p-6 group hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-sb-green">Pending</p>
                  ...
                  <p className="mt-4 text-sm text-sb-grey-2-50">Awaiting processing</p>
                </div>
                ...
                <div className="card p-6 group hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-sb-green">Errors</p>
                  ...
                  <p className="mt-4 text-sm text-sb-grey-2-50">Requires attention</p>
                </div>
                ...
                {stats.duplicates > 0 && (
                  <div className="card p-6 group hover:shadow-xl transition-all duration-300 border-l-4 border-orange-400">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm font-medium text-sb-green">Duplicates</p>
                    ...
                    <p className="mt-4 text-sm text-sb-grey-2-50">Potential duplicate invoices</p>
                  </div>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="card p-6">
                  <h3 className="text-lg font-bold text-sb-grey-1 mb-6">Recent Activity</h3>
                  <div className="space-y-5">
                    {[
                      { label: 'Today', value: stats.recentActivity.today, color: 'bg-sb-blue' },
                      { label: 'This Week', value: stats.recentActivity.thisWeek, color: 'bg-sb-light-blue' },
                      { label: 'This Month', value: stats.recentActivity.thisMonth, color: 'bg-sb-green' },
                    ].map((item, i) => (
                      <div key={i} className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          <div className={`w-3 h-3 rounded-full ${item.color}`}></div>
                          <span className="text-sm text-sb-grey-2">{item.label}</span>
                        </div>
                        <span className="text-lg font-bold text-sb-grey-1">{item.value}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                {/* Processing Status */}
                <div className="card p-6">
                  <h3 className="text-lg font-bold text-sb-grey-1 mb-6">Processing Status</h3>
                  <div className="space-y-4">
                    {[
                      { label: 'Completed', value: stats.completed, total: stats.totalInvoices, color: 'from-sb-green to-sb-green', textColor: 'text-sb-green' },
                      ...
                      <div key={i}>
                        <div className="flex justify-between text-sm mb-2">
                          <span className="text-sb-grey-2 font-medium">{item.label}</span>
                ...
                <div className="stat-card-gradient">
                  <h3 className="text-lg text-white font-bold mb-6">Success Rate</h3>
                  ...
                  <p className="text-center text-sm mt-6 text-sb-blue-10">
              ...
              {stats.completed > 0 && (
                <div className="mt-8">
                  <h3 className="text-lg font-bold text-sb-grey-1 mb-4 flex items-center space-x-2">
                    <svg className="w-5 h-5 text-sb-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                    </svg>
                    <span className='text-sb-dark-blue'>AI Insights</span>
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {/* Average Confidence */}
                    <div className="card p-6">
                      <div className="flex items-center justify-between mb-4">
                        <p className="text-sm font-medium text-sb-green">AI Confidence</p>
                        <div className={`w-3 h-3 rounded-full ${
                          stats.avgConfidence >= 80 ? 'bg-sb-green' : 
                          stats.avgConfidence >= 60 ? 'bg-amber-500' : 'bg-red-500'
                        }`}></div>
                      </div>
                      <p className={`text-3xl font-bold ${
                        stats.avgConfidence >= 80 ? 'text-sb-green' : 
                        stats.avgConfidence >= 60 ? 'text-amber-600' : 'text-red-600'
                      }`}>
                        {stats.avgConfidence}%
                      </p>
                      <p className="text-xs text-sb-grey-2-50 mt-2">Average extraction confidence</p>
                    </div>

                    {/* Total Amount Processed */}
                    <div className="card p-6">
                      <p className="text-sm font-medium text-sb-green mb-4">Total Amount</p>
                      <p className="text-3xl font-bold text-sb-grey-1">
                        ${stats.totalAmount.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                      </p>
                      <p className="text-xs text-sb-grey-2-50 mt-2">Total invoiced amount</p>
                    </div>

                    {/* Top Categories */}
                    <div className="card p-6">
                      <p className="text-sm font-medium text-sb-green mb-3">Top Categories</p>
                      {stats.topCategories.length > 0 ? (
                        <div className="space-y-2">
                          {stats.topCategories.slice(0, 3).map((cat, i) => (
                            <div key={i} className="flex items-center justify-between">
                              <span className="text-sm text-sb-grey-2 truncate">{cat.name}</span>
                              <span className="text-xs font-semibold text-sb-blue bg-sb-blue-10 px-2 py-0.5 rounded-full">{cat.count}</span>
                            </div>
                          ))}
                        </div>
                      ) : (
                        <p className="text-sm text-sb-grey-2-50">No categories yet</p>
                      )}
                    </div>

                    {/* Languages Detected */}
                    <div className="card p-6">
                      <p className="text-sm font-medium text-sb-green mb-3">Languages Detected</p>
                      {stats.languages.length > 0 ? (
                        <div className="flex flex-wrap gap-2">
                          {stats.languages.map((lang, i) => (
                            <span key={i} className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-sb-light-blue-10 text-sb-dark-blue">
                              {lang.name} ({lang.count})
                            </span>
                          ))}
                        </div>
                      ) : (
                        <p className="text-sm text-sb-grey-2-50">No languages detected</p>
                      )}
                    </div>
                  </div>
                  ...
                  {learningStats && (learningStats.total_corrections > 0 || learningStats.vendor_count > 0) && (
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                      {/* Corrections Made */}
                      <div className="card p-5 border-l-4 border-sb-blue">
                        <div className="flex items-center space-x-3">
                          <div className="p-2 bg-sb-blue-10 rounded-lg">
                            <svg className="w-5 h-5 text-sb-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                            </svg>
                          </div>
                          <div>
                            <p className="text-2xl font-bold text-sb-dark-blue">{learningStats.total_corrections}</p>
                            <p className="text-xs text-sb-grey-2">Corrections made (AI learning)</p>
                          </div>
                        </div>
                        {learningStats.fields_corrected && Object.keys(learningStats.fields_corrected).length > 0 && (
                          <div className="mt-3 flex flex-wrap gap-1">
                            {Object.entries(learningStats.fields_corrected).slice(0, 4).map(([field, count]) => (
                              <span key={field} className="text-xs px-2 py-0.5 bg-sb-blue-5 text-sb-blue rounded">
                                {field}: {count}
                              </span>
                            ))}
                          </div>
                      ...
                      {/* Vendors Recognized */}
                      <div className="card p-5 border-l-4 border-sb-green">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-2xl font-bold text-sb-dark-blue">{learningStats.vendor_count}</p>
                            <p className="text-xs text-sb-grey-2">Vendors in database</p>
                          </div>
                        </div>
                        <p className="mt-2 text-xs text-sb-grey-2-50">
            ...
            <div className="max-w-4xl mx-auto animate-fade-in">
              ...
              <div
                ...
                className={`border-2 border-dashed rounded-2xl p-16 text-center transition-all duration-300 mb-8 ${
                  dragActive
                    ? 'border-sb-blue bg-sb-blue-5 scale-[1.02]'
                    : 'border-sb-green hover:border-sb-light-blue bg-white hover:bg-sb-blue-5/50'
                }`}
              >
                <div className={`w-20 h-20 mx-auto mb-6 rounded-2xl flex items-center justify-center transition-colors ${
                  dragActive ? 'bg-sb-blue-10' : 'bg-sb-grey-2-10'
                }`}>
                  <svg
                    className={`w-10 h-10 transition-colors ${dragActive ? 'text-sb-blue' : 'text-sb-grey-2-50'}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <label htmlFor="file-upload" className="cursor-pointer">
                  <span className="text-sb-blue hover:text-sb-dark-blue font-semibold text-2xl">
                    Click to upload
                  </span>
                  <p className="text-sb-grey-2 mt-3 text-lg">or drag and drop your files here</p>
                </label>
                <input
                  id="file-upload"
                  type="file"
                  ...
                  disabled={uploading}
                />
                <p className="text-sm text-sb-grey-2-50 mt-6">
                ...
                <div className="flex flex-wrap justify-center gap-2 mt-3">
                  ...
                  <span className="px-2 py-1 bg-sb-blue-10 text-sb-blue text-xs rounded-md font-medium">JPG</span>
                  <span className="px-2 py-1 bg-green-100 text-green-700 text-xs rounded-md font-medium">PNG</span>
                  <span className="px-2 py-1 bg-sb-blue-10 text-sb-dark-blue text-xs rounded-md font-medium">GIF</span>
              ...
              <div className="card p-6 mb-8">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-sb-grey-1">Bulk Upload from Folder</h3>
                    <p className="text-sm text-sb-grey-2">Upload up to 5 invoices from a folder</p>
                  </div>
                </div>
                <input
                  id="folder-upload"
                ...
                <label htmlFor="folder-upload" className="cursor-pointer">
                  <div className="border-2 border-dashed border-sb-light-blue rounded-xl p-8 text-center hover:bg-sb-blue-5 transition-colors">
                    <svg className="w-12 h-12 text-sb-blue mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                    </svg>
                    <p className="text-sb-blue font-semibold text-lg mb-2">Select Folder</p>
                    <p className="text-sm text-sb-grey-2">Choose a folder containing invoice files (max 5 files)</p>
                  </div>
                </label>
                ...
                <div className="card p-6 animate-slide-up">
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <button
                      ...
                      className="btn-ghost text-sb-grey-2"
                    >
                      Clear All
                    </button>
                  </div>
                  <div className="space-y-3 mb-6">
                    {uploadedFiles.map((file, index) => (
                      <div
                        key={index}
                        className="flex items-center justify-between p-4 bg-sb-grey-2-10 rounded-xl border border-sb-grey-2-20 hover:border-sb-light-blue-20 transition-colors"
                      >
                        <div className="flex items-center space-x-4 flex-1 min-w-0">
                          <div className={`w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 ${
                            isImageFile(file.name) 
                              ? 'bg-gradient-to-br from-sb-light-blue to-sb-blue' 
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-sb-grey-2">
                  ...
                  {!uploading ? (
                    ...
                    <div className="text-center py-8">
                      <div className="spinner w-12 h-12 border-4 border-sb-blue mx-auto mb-4"></div>
                      <p className="text-sb-grey-2 text-lg font-medium">Uploading your invoices...</p>
                      <p className="text-sm text-sb-grey-2 mt-2">Please wait, this may take a moment</p>
                    </div>
                  )}
                </div>
              )}
            ...
            <div className="animate-fade-in">
              {invoices.length === 0 ? (
                <div className="card p-16 text-center">
                  <div className="w-20 h-20 bg-sb-grey-2-10 rounded-2xl flex items-center justify-center mx-auto mb-6">
                    <svg className="w-10 h-10 text-sb-grey-2-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold text-sb-grey-1 mb-2">No invoices yet</h3>
                  <p className="text-sb-grey-2 mb-8">Upload your first invoice to get started</p>
                  <button
                    onClick={() => setActiveView('upload')}
                ...
                <>
                  ...
                  {selectedInvoices.size > 0 && (
                    <div className="mb-4 p-4 bg-sb-blue-5 border border-sb-light-blue-20 rounded-xl flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <span className="text-sm font-semibold text-sb-grey-1">
                          {selectedInvoices.size} invoice{selectedInvoices.size !== 1 ? 's' : ''} selected
                        </span>
                        <button
                          onClick={() => setSelectedInvoices(new Set())}
                          className="text-sm text-sb-blue hover:text-sb-dark-blue font-medium"
                        >
                          Clear selection
                        </button>
                      </div>
                        ...
                        <tr>
                          <th className="table-header-cell w-12">
                            <input
                              ...
                              className="w-4 h-4 text-sb-blue border-sb-grey-2-20 rounded focus:ring-sb-blue"
                            />
                          </th>
                        ...
                        {invoices.map((invoice) => (
                          <tr key={invoice.id} className="table-row">
                            ...
                            <td className="table-cell">
                              ...
                              <div className="min-w-0">
                                <p className="font-semibold text-sb-grey-1 truncate max-w-[180px]">{invoice.filename}</p>
                                <p className="text-xs text-sb-grey-2-50">{new Date(invoice.upload_date).toLocaleDateString()}</p>
                              </div>
                            </div>
                          </td>
                          <td className="table-cell">
                            <div className="min-w-0">
                              {invoice.vendor_name ? (
                                <p className="font-medium text-sb-grey-1 truncate max-w-[150px]">{invoice.vendor_name}</p>
                              ) : (
                                <p className="text-sb-grey-2-50 text-sm">—</p>
                              )}
                              {invoice.category && (
                                <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-sb-blue-10 text-sb-dark-blue mt-1">
                                  {invoice.category}
                                </span>
                              )}
                              {invoice.detected_language && invoice.detected_language !== 'English' && (
                                <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-sb-light-blue-10 text-sb-dark-blue mt-1 ml-1">
                          ...
                          <td className="table-cell">
                            {invoice.confidence_score != null ? (
                              <div className="flex items-center space-x-2">
                                <div className="w-16 h-2 bg-sb-grey-2-20 rounded-full overflow-hidden">
                                  <div 
                                    className={`h-full rounded-full ${
                                      invoice.confidence_score >= 0.8 ? 'bg-sb-green' :
                                ...
                                <span className={`text-xs font-semibold ${
                                  invoice.confidence_score >= 0.8 ? 'text-sb-green' :
                              ...
                              <span className="text-sb-grey-2-50 text-sm">—</span>
                            )}
                          </td>
                          <td className="table-cell">
                            <div className="flex items-center space-x-2">
                              ...
                              <button
                                ...
                                className="p-1.5 text-sb-grey-2-50 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors"
