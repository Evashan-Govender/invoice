  ...
  return (
    <div className="card p-6">
      <div className="flex items-center space-x-3 mb-6">
        ...
        <div>
          <h3 className="text-lg font-bold text-sb-grey-1">Invoice Header</h3>
          <p className="text-sm text-sb-grey-2">Basic invoice information</p>
        </div>
      </div>
      ...
      {/* Financial Details */}
      <div className="mt-6 pt-6 border-t border-sb-grey-2-20">
        <h4 className="text-sm font-bold text-sb-grey-2 uppercase tracking-wide mb-4">Financial Details</h4>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="input text-right font-mono font-bold text-sb-dark-blue bg-sb-blue-5 border-sb-light-blue-20 focus:border-sb-light-blue focus:ring-sb-blue-10"
            />
          </div>
        </div>
      </div>
      ...
      <div className="mt-6 pt-6 border-t border-sb-grey-2-20">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h4 className="text-sm font-bold text-sb-grey-2 uppercase tracking-wide">Additional Information</h4>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div>
            <label className="label">
              <span className="flex items-center space-x-2">
                <svg className="w-4 h-4 text-sb-grey-2-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            />
            <p className="mt-1.5 text-xs text-sb-grey-2-50">Other information about the invoice (payment terms, references, etc.)</p>
          </div>
          ...
          <div>
            ...
            />
            <p className="mt-1.5 text-xs text-sb-grey-2-50">Any extra details or notes about this invoice</p>
          </div>
        </div>
      </div>
    </div>
