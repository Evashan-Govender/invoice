...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glow': '0 0 40px -10px rgb(124 58 237 / 0.4)',
        'glow-lg': '0 0 60px -15px rgb(124 58 237 / 0.5)',
      ...
      keyframes: {
        ...
        glow: {
          '0%, 100%': { boxShadow: '0 0 20px -5px rgb(124 58 237 / 0.4)' },
          '50%': { boxShadow: '0 0 30px -5px rgb(124 58 237 / 0.6)' },
        },
      },
      backgroundImage: {
